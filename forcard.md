...
- このカードを使用するまでのターンで**色カードを少なくとも1枚使用していること**。
  - このカードを使用した時点で色カードを一枚も使っていない場合：
    - **C01：単点塗り**と同様の効果が発揮

**効果：**

- 自分ターンで**最後に使った色カードと同じパターン** をもう一度適用する。
  - このカードをどこに配置しても、必ず**最後に使った色カードが配置されたマスと同じマスに、同じ効果が適用される**
